 ...
 <li>
  <figure class="figure">
  <img src="{{$proprietes->image ? asset($proprietes->image) : asset('uploads/images/default.png')}}" alt="{{$proprietes->name}}" class="figure-img img-fluid rounded" alt="...">
  <figcaption class="figure-caption"> {{$proprietes->localisation}}</figcaption>
  <figcaption class="figure-caption"> {{$proprietes->prix_max}}</figcaption>
  <figcaption class="figure-caption"> {{$proprietes->salle_de_bain}}</figcaption>
  <figcaption class="figure-caption"> {{$proprietes->Type_anonce->typ}}</figcaption>
  <figcaption class="figure-caption"> {{$proprietes->Type_de_proprietes->nom}}</figcaption>
