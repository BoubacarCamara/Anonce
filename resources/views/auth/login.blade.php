                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-group text-md-right">{{ __('Mot de passe') }}</label>
...
<h4 display="center">INSCRIPTION EST GRATUITE </h4>
