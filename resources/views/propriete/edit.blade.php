...
@method('patch')
               ...
               <div>
                   <input type="text" name="nombre_chambre_min" class="form-control" placeholder="nombre_chambre_min" value={{$propriete->nombre_chambre_min}}>
               </div>
               <div>
                   <input type="text" name="nombre_chambre_max" class="form-control" placeholder="nombre_chambre_min" value={{$propriete->nombre_chambre_max}}>
               </div>
               <div>
                   <input type="text" name="salle_de_bain" class="form-control" placeholder="salle de bain" value={{$propriete->salle_de_bain}}>
               </div>
               <div>
